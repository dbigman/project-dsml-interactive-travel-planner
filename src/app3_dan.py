...
def log_chat(user_input, model_reply):
    """Log a chat interaction to a JSON Lines file.

    This function records the user input and the model's reply along with a
    timestamp into a file named 'chat_logs.jsonl'. Each entry is stored in
    JSON format, allowing for easy retrieval and analysis of chat
    interactions. The function appends new entries to the file, ensuring
    that previous logs are preserved.

    Args:
        user_input (str): The input provided by the user during the chat.
